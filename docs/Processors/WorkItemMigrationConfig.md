...
| `AttachPrettyPrintComments` | Boolean | If enabled, all comments will be prettified and added into an attachment. | false
| `CommentAttachmentFormat` | String | The attachment format (json, txt, html). | json
| `AttachPrettyPrintHistory` | Boolean | If enabled, all revisions will be prettified and added into an attachment. | false
| `HistoryAttachmentFormat` | String | The attachment format (json, txt, html). | json
